...
export const SanctumGetApyTool = {
  name: "SANCTUM_GET_APY",
  description:
    "Fetch the APY of a LST(Liquid Staking Token) list on the Sanctum with specified mint addresses or symbols.",
  parameters: {
    inputs: z.array(z.string()),
  },
  execute: async ({ inputs }: SanctumGetApyToolParams) => {
    try {
