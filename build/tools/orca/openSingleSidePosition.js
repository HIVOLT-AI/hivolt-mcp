...
const OrcaOpenSingleSidePositionToolParams = zod_1.z.object({
    whirlpoolAddress: zod_1.z.string(),
    distanceFromCurrentPriceBps: zod_1.z.number(),
    widthBps: zod_1.z.number(),
    inputTokenMint: zod_1.z.string(),
    inputAmount: zod_1.z.number(),
});
exports.OrcaOpenSingleSidePositionTool = {
    ...
    execute: async ({ whirlpoolAddress, distanceFromCurrentPriceBps, widthBps, inputTokenMint, inputAmount, }) => {
        try {
            ...
            const isTokenA = new web3_js_1.PublicKey(inputTokenMint).equals(mintInfoA.mint);
            let lowerBoundPrice;
            let upperBoundPrice;
            let lowerTick;
            let upperTick;
...
//# sourceMappingURL=openSingleSidePosition.js.map