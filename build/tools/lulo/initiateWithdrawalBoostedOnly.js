...
exports.LuloInitiateWithdrawalBoostedOnlyTool = void 0;
exports.lulo_initiate_withdrawal_boosted_only = lulo_initiate_withdrawal_boosted_only;
...
const LuloInitiateWithdrawalBoostedOnlyToolParams = zod_1.z.object({
    mintAddress: zod_1.z.string(),
    amount: zod_1.z.number(),
});
exports.LuloInitiateWithdrawalBoostedOnlyTool = {
    ...
    execute: async (input) => {
        ...
        return await lulo_initiate_withdrawal_boosted_only(keypair, connection, input.mintAddress, input.amount);
    },
};
async function lulo_initiate_withdrawal_boosted_only(accountKeypair, connection, mintAddress, amount) {
    try {
...
//# sourceMappingURL=initiateWithdrawalBoostedOnly.js.map