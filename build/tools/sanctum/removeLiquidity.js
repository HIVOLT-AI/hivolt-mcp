...
exports.SanctumRemoveLiquidityTool = void 0;
...
const SanctumRemoveLiquidityToolParams = zod_1.z.object({
    lstMint: zod_1.z.string(),
    amount: zod_1.z.string(),
    quotedAmount: zod_1.z.string(),
    priorityFee: zod_1.z.number(),
});
exports.SanctumRemoveLiquidityTool = {
    name: "SANCTUM_REMOVE_LIQUIDITY",
    description: "Remove liquidity from sanctum infinite pool with specified token parameters",
    parameters: {
        lstMint: zod_1.z.string(),
        amount: zod_1.z.string(),
        quotedAmount: zod_1.z.string(),
