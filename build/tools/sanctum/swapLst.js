...
exports.SanctumSwapLstTool = void 0;
...
const SanctumSwapLstToolParams = zod_1.z.object({
    input: zod_1.z.string(),
    amount: zod_1.z.string(),
    quotedAmount: zod_1.z.string(),
    priorityFee: zod_1.z.number(),
    outputLstMint: zod_1.z.string(),
});
exports.SanctumSwapLstTool = {
    ...
    execute: async ({ input, amount, quotedAmount, priorityFee, outputLstMint, }) => {
        try {
